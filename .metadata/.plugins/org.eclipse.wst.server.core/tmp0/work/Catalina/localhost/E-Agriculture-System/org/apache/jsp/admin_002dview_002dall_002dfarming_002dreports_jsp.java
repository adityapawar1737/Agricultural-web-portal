 ...
 * Generated at: 2022-04-11 03:35:07 UTC
...
public final class admin_002dview_002dall_002dfarming_002dreports_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<strong>View All Reports</strong>\r\n");
      out.write("\t\t\t\t</h4>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"panel panel-default shadow p-3 mb-5\">\r\n");
      out.write("\t\t\t<div class=\"panel-body\">\r\n");
      out.write("\t\t\t\t<div class=\"alert alert-warning shadow p-3 mb-5\" style=\"text-transform: uppercase\">Agricultural Web Portal All\r\n");
      out.write("\t\t\t\t\tReports</div>\r\n");
      ...
      out.write("\t\t\t\t\t\tAgricultural Web Portal All Reports &nbsp;[&nbsp;");
      ...
      out.write("\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t<form action=\"AllCustomersReport\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>All Customers Report</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"submit\" value=\"Generate Reports\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-info\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t<form action=\"AllCropSellingsReport\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>Crop Selling Report</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"submit\" value=\"Generate Reports\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-danger\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t<form action=\"AllBuyersReport\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>All Buyers Report</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"submit\" value=\"Generate Reports\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t\t\t<form action=\"AllContactsReport\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>All Contacts Report</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><input type=\"submit\" value=\"Generate Reports\"\r\n");
